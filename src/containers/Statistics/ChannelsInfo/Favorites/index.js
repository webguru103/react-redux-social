    ...
    getChartsData() {
        ...
        switch(this.state.channel.connection.channel) {
            case 'pinterest':
                ...
                for(i in pinterest) {
                    temp = { name: this.getNameDate(pinterest[i].top_pins_by_engagement["0"].created_at), favorites: pinterest[i].repins, amt: pinterest[i].repins };
                    data.push(temp);
                }
                break;
            case 'twitter':
                ...
                for(i in twitter) {
                    temp = { name: this.getNameDate(twitter[i].top_tweets_by_engagement["0"].created_at), favorites: twitter[i].retweet_count, amt: twitter[i].retweet_count };
                    data.push(temp);
                }
                break;
            case 'facebook':
                ...
                for(i in facebook) {
                    temp = { name: this.getNameDate(facebook[i].top_posts_by_engagement["0"].created_time), favorites: facebook[i].post_count, amt: facebook[i].post_count };
                    data.push(temp);
                }
                break;
            case 'linkedin':
                ...
                for(i in linkedin) {
                    temp = { name: this.getNameDate(linkedin[i].top_posts_by_engagement["0"].timestamp), favorites: linkedin[i].post_count, amt: linkedin[i].post_count };
                    data.push(temp);
                }
                break;
            default:
